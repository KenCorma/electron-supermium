...
declare namespace Electron {
  ...
  class WebContents extends NodeEventEmitter {
     ...
     * wheel.
     */
    on(event: 'run-dialog', listener: any): this;
    on(event: 'add-new-contents', listener: (event: Electron.Event, webContents: Electron.WebContents, disposition: string,
      _userGesture: boolean, _left: number, _top: number, _width: number, _height: number, url: string, frameName: string,
      referrer: Electron.Referrer, rawFeatures: string, postData: any) => void): this;
